export default function Page() {
    return (
        <div className={"flex flex-col h-full mb-24 items-start md:items-center justify-center max-w-[1000px] w-full"}>
            ...
            <a href={"mailto:reshadsadik@gmail.com"} className={"w-full md:w-fit accent hover-btn accent-border border p-4 px-8 text-md font-monospace rounded hover:bg-green-600 hover:text-white"}>
                Say Hello
            </a>
        </div>
    )
